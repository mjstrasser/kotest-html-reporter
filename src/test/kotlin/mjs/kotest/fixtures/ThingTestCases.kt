...
const val name0 = "Describe the thing"
val descriptor0 = Descriptor.TestDescriptor(specDescriptor, DescriptorId(name0))
val case0 =
    TestCase(descriptor0, TestName(name0), thingTest, {}, SourceRef.FileSource("ThingTest.kt", 8), TestType.Test)
...
val case1 =
    TestCase(descriptor1, TestName(name1), thingTest, {}, SourceRef.FileSource("ThingTest,kt", 9), TestType.Test)
...
val case2 =
    TestCase(descriptor2, TestName(name2), thingTest, {}, SourceRef.FileSource("ThingTest,kt", 12), TestType.Test)
...
val case2a =
    TestCase(descriptor2a, TestName(name2a), thingTest, {}, SourceRef.FileSource("ThingTest,kt", 13), TestType.Test)
...
val case2b =
    TestCase(descriptor2b, TestName(name2b), thingTest, {}, SourceRef.FileSource("ThingTest,kt", 16), TestType.Test)
...
val case3 =
    TestCase(descriptor3, TestName(name3), thingTest, {}, SourceRef.FileSource("ThingTest,kt", 20), TestType.Test)
